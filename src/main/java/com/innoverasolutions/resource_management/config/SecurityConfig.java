    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/investments/**").permitAll() // Allow unrestricted access to Investments Module
                        .requestMatchers("/payments/**").permitAll()    // Allow unrestricted access to Payments Module
